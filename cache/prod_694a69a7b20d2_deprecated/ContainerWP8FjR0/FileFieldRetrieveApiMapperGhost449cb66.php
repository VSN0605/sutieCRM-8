...
include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'backend'.\DIRECTORY_SEPARATOR.'Module'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'Fields'.\DIRECTORY_SEPARATOR.'File'.\DIRECTORY_SEPARATOR.'Mappers'.\DIRECTORY_SEPARATOR.'FileFieldRetrieveApiMapper.php';
class FileFieldRetrieveApiMapperGhost449cb66 extends \App\Module\Service\Fields\File\Mappers\FileFieldRetrieveApiMapper implements \Symfony\Component\VarExporter\LazyObjectInterface
{
...
if (!\class_exists('FileFieldRetrieveApiMapperGhost449cb66', false)) {
    \class_alias(__NAMESPACE__.'\\FileFieldRetrieveApiMapperGhost449cb66', 'FileFieldRetrieveApiMapperGhost449cb66', false);
}
