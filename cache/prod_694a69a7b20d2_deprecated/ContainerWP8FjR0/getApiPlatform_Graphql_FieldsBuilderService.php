...
class getApiPlatform_Graphql_FieldsBuilderService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'GraphQl'.\DIRECTORY_SEPARATOR.'Metadata'.\DIRECTORY_SEPARATOR.'RuntimeOperationMetadataFactory.php';
        ...
        $g = ($container->privates['api_platform.hydra.name_converter.hydra_prefix'] ?? self::getApiPlatform_Hydra_NameConverter_HydraPrefixService($container));
        ...
        $k = ($container->privates['api_platform.validator'] ?? $container->load('getApiPlatform_ValidatorService'));
        $l = new \ApiPlatform\GraphQl\State\Processor\NormalizeProcessor($j, $h, $e);

        return $container->privates['api_platform.graphql.fields_builder'] = new \ApiPlatform\GraphQl\Type\FieldsBuilder(($container->privates['api_platform.metadata.property.name_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Property_NameCollectionFactory_CachedService($container)), $a, $b, ($container->privates['api_platform.resource_class_resolver'] ?? self::getApiPlatform_ResourceClassResolverService($container)), $c, $f, new \ApiPlatform\GraphQl\Type\TypeConverter($f, $c, $b, $a), new \ApiPlatform\GraphQl\Resolver\Factory\ResolverFactory(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\Symfony\Validator\State\ValidateProvider(new \ApiPlatform\GraphQl\State\Provider\ResolverProvider(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\Symfony\Validator\State\ValidateProvider(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\GraphQl\State\Provider\DenormalizeProvider(new \ApiPlatform\State\Provider\ParameterProvider(new \ApiPlatform\Symfony\Security\State\AccessCheckerProvider(new \ApiPlatform\GraphQl\State\Provider\ReadProvider(($container->privates['api_platform.state_provider.locator'] ?? self::getApiPlatform_StateProvider_LocatorService($container)), $d, $h, '_'), $i), ($container->privates['.service_locator.sL05zc0'] ?? self::get_ServiceLocator_SL05zc0Service($container))), $j, $h), $i, 'post_denormalize'), $k), $i, 'post_validate'), new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
        ...
        ])), $k, 'canValidateAfterResolver'), $i, 'after_resolver'), new \ApiPlatform\State\Processor\WriteProcessor(new \ApiPlatform\GraphQl\State\Processor\SubscriptionProcessor($l, new \ApiPlatform\GraphQl\Subscription\SubscriptionManager(($container->privates['api_platform.graphql.cache.subscription'] ?? $container->load('getApiPlatform_Graphql_Cache_SubscriptionService')), new \ApiPlatform\GraphQl\Subscription\SubscriptionIdentifierGenerator(), $l, $d, $b), NULL), ($container->privates['api_platform.state_processor.locator'] ?? $container->load('getApiPlatform_StateProcessor_LocatorService'))), new \ApiPlatform\GraphQl\Metadata\RuntimeOperationMetadataFactory($b, ($container->privates['api_platform.router'] ?? self::getApiPlatform_RouterService($container)))), NULL, NULL, NULL, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), $e, $g, '_', ($container->privates['api_platform.metadata.inflector'] ??= new \ApiPlatform\Metadata\Util\Inflector(false)));
    }
}
