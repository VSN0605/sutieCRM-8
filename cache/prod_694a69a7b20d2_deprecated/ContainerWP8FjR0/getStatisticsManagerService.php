...
class getStatisticsManagerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Statistics\\Service\\StatisticsManager'])) {
            return $container->privates['App\\Statistics\\Service\\StatisticsManager'];
        }

        $container->privates['App\\Statistics\\Service\\StatisticsManager'] = $instance = new \App\Statistics\Service\StatisticsManager($a);
