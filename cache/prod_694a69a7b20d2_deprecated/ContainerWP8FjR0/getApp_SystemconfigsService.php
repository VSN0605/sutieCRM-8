...
class getApp_SystemconfigsService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'backend'.\DIRECTORY_SEPARATOR.'SystemConfig'.\DIRECTORY_SEPARATOR.'Service'.\DIRECTORY_SEPARATOR.'SystemConfigProviderInterface.php';
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'backend'.\DIRECTORY_SEPARATOR.'SystemConfig'.\DIRECTORY_SEPARATOR.'LegacyHandler'.\DIRECTORY_SEPARATOR.'SystemConfigHandler.php';
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'backend'.\DIRECTORY_SEPARATOR.'Routes'.\DIRECTORY_SEPARATOR.'LegacyHandler'.\DIRECTORY_SEPARATOR.'ClassicViewRoutingExclusionsHandler.php';
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'backend'.\DIRECTORY_SEPARATOR.'SystemConfig'.\DIRECTORY_SEPARATOR.'LegacyHandler'.\DIRECTORY_SEPARATOR.'SystemConfigMappers.php';
        ...
        }, 6)), ($container->privates['App\\Currency\\LegacyHandler\\CurrencyHandler'] ?? $container->load('getCurrencyHandlerService')), ($container->privates['App\\Install\\LegacyHandler\\InstallHandler'] ?? $container->load('getInstallHandlerService')), $container->parameters['legacy.system_config_key_map'], $container->parameters['legacy.cache_reset_actions'], $container->parameters['themes.navigation_tab_limits'], $container->parameters['module.filter.range_search_types'], $container->parameters['module.listview.column_limits'], $container->parameters['module.listview.settings_limits'], $container->parameters['module.listview.actions_limits'], $container->parameters['module.recordview.actions_limits'], $container->parameters['module.recordview.section_tab_limits'], $container->parameters['module.subpanelview.actions_limits'], $container->parameters['module.listview.line_actions_limits'], $container->parameters['module.listview.url_query_filter_mapping'], $container->parameters['ui'], $container->parameters['notifications'], $container->parameters['notifications_reload_actions'], $container->parameters['global_recently_viewed_reload_actions'], $container->parameters['extensions'], $container->parameters['auth.logout'], $container->parameters['auth.session-expired'], $container->parameters['module.recordview.convert_ignore'], $container->parameters['module.recordview.duplicate_ignore'], $container->parameters['module.recordview.subpanel_button_limits'], $b, ($container->privates['App\\Navbar\\LegacyHandler\\NavbarHandler'] ?? $container->load('getNavbarHandlerService')));
    }
}
