...
class getDoctrine_Migrations_DependencyFactoryService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setDefinition('Doctrine\\Migrations\\Version\\MigrationFactory', #[\Closure(name: 'App\\Install\\Service\\Migrations\\MigrationFactoryDecorator')] fn () => ($container->privates['App\\Install\\Service\\Migrations\\MigrationFactoryDecorator'] ?? $container->load('getMigrationFactoryDecoratorService')));
