...
class getApiRecordMapperRunnerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Data\\Service\\Record\\ApiRecordMappers\\ApiRecordMapperRunner'])) {
            return $container->privates['App\\Data\\Service\\Record\\ApiRecordMappers\\ApiRecordMapperRunner'];
        }

        return $container->privates['App\\Data\\Service\\Record\\ApiRecordMappers\\ApiRecordMapperRunner'] = new \App\Data\Service\Record\ApiRecordMappers\ApiRecordMapperRunner(\App\Data\Service\Record\Mappers\BaseFieldMapperRegistryFactory::create(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Schedulers\\Service\\Fields\\JobIntervalListApiMapper'] ?? $container->load('getJobIntervalListApiMapperService'));
            yield 1 => ($container->privates['App\\Schedulers\\Service\\Fields\\RangeListApiMapper'] ?? $container->load('getRangeListApiMapperService'));
            yield 2 => ($container->privates['App\\Module\\EmailMarketing\\Service\\Fields\\TrackersEnabledRetrieveApiMapper'] ?? $container->load('getTrackersEnabledRetrieveApiMapperService'));
        }, 3)), \App\Data\Service\Record\Mappers\BaseFieldTypeMapperRegistryFactory::create(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Module\\Service\\Fields\\Attachments\\Mappers\\AttachmentFieldListApiMapper'] ?? $container->load('getAttachmentFieldListApiMapperService'));
            yield 1 => ($container->privates['App\\Module\\Service\\Fields\\Attachments\\Mappers\\AttachmentFieldRetrieveMapper'] ?? $container->load('getAttachmentFieldRetrieveMapperService'));
            yield 2 => ($container->privates['App\\Module\\Service\\Fields\\Attachments\\Mappers\\AttachmentFieldSaveApiMapper'] ?? $container->load('getAttachmentFieldSaveApiMapperService'));
            yield 3 => ($container->privates['App\\Module\\Service\\Fields\\File\\Mappers\\FileFieldListApiMapper'] ?? $container->load('getFileFieldListApiMapperService'));
            yield 4 => ($container->privates['App\\Module\\Service\\Fields\\File\\Mappers\\FileFieldRetrieveApiMapper'] ?? $container->load('getFileFieldRetrieveApiMapperService'));
            yield 5 => ($container->privates['App\\Module\\Service\\Fields\\File\\Mappers\\FileFieldSaveApiMapper'] ?? $container->load('getFileFieldSaveApiMapperService'));
            yield 6 => ($container->privates['App\\Module\\Service\\Fields\\LineItems\\Mappers\\LineItemsListApiMapper'] ?? $container->load('getLineItemsListApiMapperService'));
            yield 7 => ($container->privates['App\\Module\\Service\\Fields\\LineItems\\Mappers\\LineItemsRetrieveApiMapper'] ?? $container->load('getLineItemsRetrieveApiMapperService'));
            yield 8 => ($container->privates['App\\Module\\Service\\Fields\\LineItems\\Mappers\\LineItemsSaveApiMapper'] ?? $container->load('getLineItemsSaveApiMapperService'));
        }, 9)), \App\Data\Service\Record\Mappers\BaseRecordMapperRegistryFactory::create(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\Module\\Campaigns\\Service\\Record\\ApiRecordMappers\\CampaignsTargetListsRetrieveApiMapper'] ??= new \App\Module\Campaigns\Service\Record\ApiRecordMappers\CampaignsTargetListsRetrieveApiMapper());
            yield 1 => ($container->privates['App\\Module\\Campaigns\\Service\\Record\\ApiRecordMappers\\CampaignsTargetListsSaveApiMapper'] ??= new \App\Module\Campaigns\Service\Record\ApiRecordMappers\CampaignsTargetListsSaveApiMapper());
        }, 2)), $a);
    }
}
