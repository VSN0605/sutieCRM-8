...
class getDeleteAllRecordThreadListActionService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Process\\Service\\RecordThreadListActions\\DeleteAllRecordThreadListAction'])) {
            return $container->privates['App\\Process\\Service\\RecordThreadListActions\\DeleteAllRecordThreadListAction'];
        }

        return $container->privates['App\\Process\\Service\\RecordThreadListActions\\DeleteAllRecordThreadListAction'] = new \App\Process\Service\RecordThreadListActions\DeleteAllRecordThreadListAction(($container->privates['App\\Module\\LegacyHandler\\ModuleNameMapperHandler'] ?? self::getModuleNameMapperHandlerService($container)), $a);
    }
}
