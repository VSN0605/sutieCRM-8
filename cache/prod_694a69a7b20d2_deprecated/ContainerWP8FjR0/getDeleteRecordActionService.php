...
class getDeleteRecordActionService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Process\\Service\\RecordActions\\DeleteRecordAction'])) {
            return $container->privates['App\\Process\\Service\\RecordActions\\DeleteRecordAction'];
        }

        return $container->privates['App\\Process\\Service\\RecordActions\\DeleteRecordAction'] = new \App\Process\Service\RecordActions\DeleteRecordAction(($container->privates['App\\Module\\LegacyHandler\\ModuleNameMapperHandler'] ?? self::getModuleNameMapperHandlerService($container)), $a);
    }
}
