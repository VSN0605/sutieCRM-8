...
class getApiPlatform_Graphql_Action_GraphiqlService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['api_platform.graphql.action.graphiql'] = new \ApiPlatform\GraphQl\Action\GraphiQlAction(($container->privates['twig'] ?? $container->load('getTwigService')), ($container->privates['api_platform.router'] ?? self::getApiPlatform_RouterService($container)), false, 'SuiteCRM API', NULL);
    }
}
