...
class getCaseAccountGetDateEnteredService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'Cases'.\DIRECTORY_SEPARATOR.'Statistics'.\DIRECTORY_SEPARATOR.'CaseAccountGetDateEntered.php';

        return $container->privates['App\\Module\\Cases\\Statistics\\CaseAccountGetDateEntered'] = new \App\Module\Cases\Statistics\CaseAccountGetDateEntered(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'SCRMSESSID', 'SCRMSESSID', ($container->privates['App\\Engine\\LegacyHandler\\LegacyScopeState'] ??= new \App\Engine\LegacyHandler\LegacyScopeState()), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
}
