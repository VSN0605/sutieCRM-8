...
class getSetupEnvService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['App\\Install\\Service\\LegacyMigration\\Steps\\SetupEnv'] = function ($container) {
            return new \App\Install\Service\LegacyMigration\Steps\SetupEnv(($container->privates['App\\Install\\LegacyHandler\\InstallHandler'] ?? $container->load('getInstallHandlerService')), ($container->services['kernel'] ?? $container->get('kernel', 1)));
        };

        return $container->factories['service_container']['App\\Install\\Service\\LegacyMigration\\Steps\\SetupEnv']($container);
    }
}
