...
class getConsole_CommandLoaderService extends App_KernelProdContainer
{
    ...
    {
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'console'.\DIRECTORY_SEPARATOR.'CommandLoader'.\DIRECTORY_SEPARATOR.'CommandLoaderInterface.php';
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'console'.\DIRECTORY_SEPARATOR.'CommandLoader'.\DIRECTORY_SEPARATOR.'ContainerCommandLoader.php';
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Install\\Command\\CopyLegacyAssets' => ['privates', 'App\\Install\\Command\\CopyLegacyAssets', 'getCopyLegacyAssetsService', true],
            'App\\Install\\Command\\InstallExtensionAssets' => ['privates', 'App\\Install\\Command\\InstallExtensionAssets', 'getInstallExtensionAssetsService', true],
            'App\\Install\\Command\\LegacyInstallCommand' => ['privates', 'App\\Install\\Command\\LegacyInstallCommand', 'getLegacyInstallCommandService', true],
            'App\\Install\\Command\\SetupLegacyMigrationCommand' => ['privates', 'App\\Install\\Command\\SetupLegacyMigrationCommand', 'getSetupLegacyMigrationCommandService', true],
            'App\\Install\\Command\\UpgradeCommand' => ['privates', 'App\\Install\\Command\\UpgradeCommand', 'getUpgradeCommandService', true],
            'App\\Install\\Command\\UpgradeFinalizeCommand' => ['privates', 'App\\Install\\Command\\UpgradeFinalizeCommand', 'getUpgradeFinalizeCommandService', true],
            'App\\Schedulers\\Command\\RunSchedulersCommand' => ['privates', 'App\\Schedulers\\Command\\RunSchedulersCommand', 'getRunSchedulersCommandService', true],
            'App\\Schedulers\\Command\\ShowSchedulersCommand' => ['privates', 'App\\Schedulers\\Command\\ShowSchedulersCommand', 'getShowSchedulersCommandService', true],
            ...
            'shivas_versioning.command.status' => ['privates', '.shivas_versioning.command.status.lazy', 'get_ShivasVersioning_Command_Status_LazyService', true],
            'shivas_versioning.command.list_providers' => ['privates', '.shivas_versioning.command.list_providers.lazy', 'get_ShivasVersioning_Command_ListProviders_LazyService', true],
            'shivas_versioning.command.version_bump' => ['privates', '.shivas_versioning.command.version_bump.lazy', 'get_ShivasVersioning_Command_VersionBump_LazyService', true],
            ...
            'App\\Install\\Command\\CopyLegacyAssets' => 'App\\Install\\Command\\CopyLegacyAssets',
            'App\\Install\\Command\\InstallExtensionAssets' => 'App\\Install\\Command\\InstallExtensionAssets',
            'App\\Install\\Command\\LegacyInstallCommand' => 'App\\Install\\Command\\LegacyInstallCommand',
            'App\\Install\\Command\\SetupLegacyMigrationCommand' => 'App\\Install\\Command\\SetupLegacyMigrationCommand',
            'App\\Install\\Command\\UpgradeCommand' => 'App\\Install\\Command\\UpgradeCommand',
            'App\\Install\\Command\\UpgradeFinalizeCommand' => 'App\\Install\\Command\\UpgradeFinalizeCommand',
            'App\\Schedulers\\Command\\RunSchedulersCommand' => 'App\\Schedulers\\Command\\RunSchedulersCommand',
            'App\\Schedulers\\Command\\ShowSchedulersCommand' => 'App\\Schedulers\\Command\\ShowSchedulersCommand',
            ...
            'api_platform.graphql.command.export_command' => 'ApiPlatform\\Symfony\\Bundle\\Command\\GraphQlExportCommand',
