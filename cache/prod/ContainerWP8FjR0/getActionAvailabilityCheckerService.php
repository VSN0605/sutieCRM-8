...
class getActionAvailabilityCheckerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Engine\\Service\\ActionAvailabilityChecker\\ActionAvailabilityChecker'] = new \App\Engine\Service\ActionAvailabilityChecker\ActionAvailabilityChecker(new RewindableGenerator(function () use ($container) {
            ...
            yield 2 => ($container->privates['App\\Engine\\LegacyHandler\\ActionAvailabilityChecker\\Checkers\\PortalUserActionChecker'] ?? $container->load('getPortalUserActionCheckerService'));
            yield 3 => ($container->privates['App\\Engine\\Service\\ActionAvailabilityChecker\\Checkers\\ACLActionChecker'] ?? $container->load('getACLActionCheckerService'));
            yield 4 => ($container->privates['App\\Engine\\Service\\ActionAvailabilityChecker\\Checkers\\MassUpdateActionChecker'] ?? $container->load('getMassUpdateActionCheckerService'));
            yield 5 => ($container->privates['App\\Module\\EmailMarketing\\Checkers\\EmailMarketingStatusActionChecker'] ?? $container->load('getEmailMarketingStatusActionCheckerService'));
        }, 6));
    }
}
