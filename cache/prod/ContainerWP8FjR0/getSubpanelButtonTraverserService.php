...
class getSubpanelButtonTraverserService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\ViewDefinitions\\LegacyHandler\\SubpanelButtonTraverser'] = new \App\ViewDefinitions\LegacyHandler\SubpanelButtonTraverser(($container->privates['App\\Module\\LegacyHandler\\ModuleNameMapperHandler'] ?? self::getModuleNameMapperHandlerService($container)), new \App\ViewDefinitions\LegacyHandler\SubpanelButtonMappers(new RewindableGenerator(function () use ($container) {
