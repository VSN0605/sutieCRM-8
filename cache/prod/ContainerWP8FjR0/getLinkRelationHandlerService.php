...
class getLinkRelationHandlerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Process\\LegacyHandler\\LinkRelationHandler'])) {
            return $container->privates['App\\Process\\LegacyHandler\\LinkRelationHandler'];
        }

        $container->privates['App\\Process\\LegacyHandler\\LinkRelationHandler'] = $instance = new \App\Process\LegacyHandler\LinkRelationHandler(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'SCRMSESSID', 'SCRMSESSID', ($container->privates['App\\Engine\\LegacyHandler\\LegacyScopeState'] ??= new \App\Engine\LegacyHandler\LegacyScopeState()), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), ($container->privates['App\\Module\\LegacyHandler\\ModuleNameMapperHandler'] ?? self::getModuleNameMapperHandlerService($container)), $a);
