 ...
 */
class getWonOpportunityAmountByYearService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Module\Opportunities\Statistics\WonOpportunityAmountByYear' shared autowired service.
     *
     * @return \App\Module\Opportunities\Statistics\WonOpportunityAmountByYear
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'Opportunities'.\DIRECTORY_SEPARATOR.'Statistics'.\DIRECTORY_SEPARATOR.'WonOpportunityAmountByYear.php';

        return $container->privates['App\\Module\\Opportunities\\Statistics\\WonOpportunityAmountByYear'] = new \App\Module\Opportunities\Statistics\WonOpportunityAmountByYear(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'SCRMSESSID', 'SCRMSESSID', ($container->privates['App\\Engine\\LegacyHandler\\LegacyScopeState'] ??= new \App\Engine\LegacyHandler\LegacyScopeState()), ($container->privates['App\\Module\\LegacyHandler\\ModuleNameMapperHandler'] ?? self::getModuleNameMapperHandlerService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
}
