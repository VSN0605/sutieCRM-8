...
class getShivasVersioning_ManagerService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['shivas_versioning.manager'] = $instance = new \Shivas\VersioningBundle\Service\VersionManager(($container->services['shivas_versioning.cache.version'] ?? $container->load('getShivasVersioning_Cache_VersionService')), new \Shivas\VersioningBundle\Writer\VersionWriter(\dirname(__DIR__, 3)), new \Shivas\VersioningBundle\Formatter\GitDescribeFormatter());

        $instance->addProvider(($container->services['app.version.provider'] ??= new \Shivas\VersioningBundle\Provider\VersionProvider(\dirname(__DIR__, 3))), 'version', 100);
