...
class getRunLegacyInstallService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->factories['service_container']['App\\Install\\Service\\Installation\\Steps\\RunLegacyInstall'] = function ($container) {
            return new \App\Install\Service\Installation\Steps\RunLegacyInstall(($container->privates['App\\Install\\LegacyHandler\\InstallHandler'] ?? $container->load('getInstallHandlerService')));
        };

        return $container->factories['service_container']['App\\Install\\Service\\Installation\\Steps\\RunLegacyInstall']($container);
    }
}
