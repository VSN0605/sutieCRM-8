...
class getAssignedUserOpportunitiesCountService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['App\\Module\\Users\\Statistics\\AssignedUserOpportunitiesCount'])) {
            return $container->privates['App\\Module\\Users\\Statistics\\AssignedUserOpportunitiesCount'];
        }

        $container->privates['App\\Module\\Users\\Statistics\\AssignedUserOpportunitiesCount'] = $instance = new \App\Module\Users\Statistics\AssignedUserOpportunitiesCount(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'SCRMSESSID', 'SCRMSESSID', ($container->privates['App\\Engine\\LegacyHandler\\LegacyScopeState'] ??= new \App\Engine\LegacyHandler\LegacyScopeState()), ($container->privates['App\\Module\\LegacyHandler\\ModuleNameMapperHandler'] ?? self::getModuleNameMapperHandlerService($container)), $a, ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
