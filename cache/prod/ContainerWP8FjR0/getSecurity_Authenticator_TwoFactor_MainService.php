...
class getSecurity_Authenticator_TwoFactor_MainService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b = ($container->services['2fa_success'] ?? $container->load('get2faSuccessService'));
        ...
        return $container->privates['security.authenticator.two_factor.main'] = new \Scheb\TwoFactorBundle\Security\Http\Authenticator\TwoFactorAuthenticator($a, ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), $b, ($container->services['2fa_failed'] ??= new \App\Security\TwoFactor\TwoFactorAuthenticationFailureHandler()), ($container->services['2fa_required'] ??= new \App\Security\TwoFactor\TwoFactorAuthenticationRequiredHandler()), $c, ($container->services['monolog.logger.security'] ?? self::getMonolog_Logger_SecurityService($container)));
    }
}
