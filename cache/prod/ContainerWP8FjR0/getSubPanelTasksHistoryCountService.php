 ...
 */
class getSubPanelTasksHistoryCountService extends App_KernelProdContainer
{
    /*
     * Gets the private 'App\Module\Tasks\Statistics\Subpanels\SubPanelTasksHistoryCount' shared autowired service.
     *
     * @return \App\Module\Tasks\Statistics\Subpanels\SubPanelTasksHistoryCount
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'Tasks'.\DIRECTORY_SEPARATOR.'Statistics'.\DIRECTORY_SEPARATOR.'Subpanels'.\DIRECTORY_SEPARATOR.'SubPanelTasksHistoryCount.php';

        return $container->privates['App\\Module\\Tasks\\Statistics\\Subpanels\\SubPanelTasksHistoryCount'] = new \App\Module\Tasks\Statistics\Subpanels\SubPanelTasksHistoryCount(\dirname(__DIR__, 3), (\dirname(__DIR__, 3).'/public/legacy'), 'SCRMSESSID', 'SCRMSESSID', ($container->privates['App\\Engine\\LegacyHandler\\LegacyScopeState'] ??= new \App\Engine\LegacyHandler\LegacyScopeState()), ($container->privates['App\\Module\\LegacyHandler\\ModuleNameMapperHandler'] ?? self::getModuleNameMapperHandlerService($container)), ($container->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()));
    }
}
