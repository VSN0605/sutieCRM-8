...
class getLeadDaysOpenService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'Leads'.\DIRECTORY_SEPARATOR.'Statistics'.\DIRECTORY_SEPARATOR.'LeadDaysOpen.php';

        $a = ($container->services['doctrine.orm.default_entity_manager'] ?? self::getDoctrine_Orm_DefaultEntityManagerService($container));

        if (isset($container->privates['App\\Module\\Leads\\Statistics\\LeadDaysOpen'])) {
            return $container->privates['App\\Module\\Leads\\Statistics\\LeadDaysOpen'];
        }
